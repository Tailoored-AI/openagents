...
export function AppHeader({ breadcrumbs = [] }: Props) {
    ...
    const agentsUrl = currentTeam ? agents(currentTeam.slug) : '/';
    const integrationsUrl = currentTeam ? integrations(currentTeam.slug) : '/';
    const knowledgeUrl = currentTeam ? knowledge(currentTeam.slug) : '/';
